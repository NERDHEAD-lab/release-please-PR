...
exports['GenericJson updateContent updates matching entry with custom version pattern 1'] = `
{
  "name": "sample",
...
exports['GenericJson updateContent updates matching entry with custom version pattern with jsonPath 1'] = `
{
  "name": "sample",
  "version": "0.5.0",
  "$version": "https://example.com/schemas/https://example.com/schemas/2.3.4/schema.json/schema.json",
  "description": "A sample esy file.",
  "author": "Example <example@example.org>",
  "license": "Apache-2.0",
  "dependencies": {
